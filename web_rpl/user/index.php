    ...
    <nav class="navbar fixed-top sticky-top navbar-expand-lg bg-body-tertiary bg-dark" data-bs-theme="dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <!-- Form Pencarian -->
                <form class="d-flex w-75" style="padding-left: 30px;" role="search" action="" method="post">
                    <input class="form-control me-2" type="search" placeholder="Cari Nama Produk" aria-label="Search" id="keyword" name="keyword">
                    <button class="btn btn-outline-success" type="submit" name="cari" id="tombol-cari">
        ...
        <div class="container produk mt-4" style="width: 60%;">
            <div class="row">
                <div class="owl-carousel owl-theme">
                    <div class="item">
                        <img src="img/banner 1.jpg" alt="asus"
                            style="width: 200px; height: 200px; margin: auto; border-radius: 5px; box-shadow: rgba(0, 0, 0, 0.479) 4px 4px 15px;">
                    </div>
                    <div class="item">
                        <img src="img/banner 2.jpg" alt="asus"
                            style="width: 200px; height: 200px; margin: auto; border-radius: 5px; box-shadow: rgba(0, 0, 0, 0.479) 4px 4px 15px;">
                    </div>
                    <div class="item">
                        <img src="img/banner 3.jpg" alt="asus"
                            style="width: 200px; height: 200px; margin: auto; border-radius: 5px; box-shadow: rgba(0, 0, 0, 0.479) 4px 4px 15px;">
                    </div>
                    <div class="item">
                        <img src="img/banner 4.jpg" alt="asus"
                            style="width: 200px; height: 200px; margin: auto; border-radius: 5px; box-shadow: rgba(0, 0, 0, 0.479) 4px 4px 15px;">
                    </div>
                    <div class="item">
                        <img src="img/banner 5.jpg" alt="asus"
                            style="width: 200px; height: 200px; margin: auto; border-radius: 5px; box-shadow: rgba(0, 0, 0, 0.479) 4px 4px 15px;">
                    </div>
                    <div class="item">
                        <img src="img/banner 6.jpg" alt="asus"
                            style="width: 200px; height: 200px; margin: auto; border-radius: 5px; box-shadow: rgba(0, 0, 0, 0.479) 4px 4px 15px;">
                    </div>
                </div>
            </div>
